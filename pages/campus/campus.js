...
Page({
  ...
  data: {
    cId:null,
    campusArray: [{ name: "所有地区", id: 1 }, { name: "Amherst,MA 周边", id: 2 }, { name: "UConn, CT 周边", id: 3 }, { name: "Worcester,MA 周边", id: 4 }, { name:"Stony Brook, NY 周边",id:5},{name:"Harrisburg, PA 周边",id:6}],
